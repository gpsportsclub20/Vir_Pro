...
Naming a Python variable with string data type.

.. code:: ipython3

    # Declaring pile type as <str>
...
Assigning integer data type to a Python variable

.. code:: ipython3

    # Declaring the exposed height of a retaining wall as <int>
    H_exposed = 4

Floating points <*float*>
^^^^^^^^^^^^^^^^^^^^^^^^^

Assigning floating point number to a Python variable
...
Compiling data into a Python list which is ordered and changeable

.. code:: ipython3

    # Storing pile diameters as a <list>
...
Storing a set of key-value pairs which is unordered, changeable and indexed

.. code:: ipython3

    # Storing pile types and their corresponding diameter as a <dict>
...
to compute geotechnics related parameters.
...
:math:`Q` = Working load of rigid pile
...
.. dropdown:: Click Me for the Solution!
   ...
   .. hint::
      ...
      .. code-block:: Python
        ...
        # Setting the angle of interest to be 30 degrees
        theta = 30
